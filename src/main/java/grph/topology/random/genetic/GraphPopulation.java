...
public class GraphPopulation extends Population<Grph, Grph>
{
	...
	public GraphPopulation()
	{
		...
		getRepresentation().getMutationOperators()
				.add(new UndirectedSimpleEdgeAdditionMutation());
		// getMutationOperators().add(new
		// DirectedSimpleEdgeAdditionMutationOperator());
