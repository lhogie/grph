...
{
	public abstract Grph readGraph(InputStream is)
			throws ParseException, IOException, GraphBuildException;

	public final Grph readGraph(RegularFile inFile)
	...
	public final Grph readGraph(byte[] bytes) throws ParseException, GraphBuildException
	{
		...
		try
		{
			return readGraph(new ByteArrayInputStream(bytes));
		}
	...
	public static AbstractGraphReader findReader(String extension)
	{
		...
		if (clazz == null)
		{
			throw new IllegalArgumentException(
					"cannot find a reader for extension: " + extension);
		}
		else
		{
