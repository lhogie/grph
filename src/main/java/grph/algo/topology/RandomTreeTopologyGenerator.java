...
public class RandomTreeTopologyGenerator extends RandomizedTopologyTransform
{
	...
	{
		LucIntSet connectedV = new SelfAdaptiveIntSet(g.getNumberOfVertices());
		LucIntSet unconnectedV = new SelfAdaptiveIntSet(g.getNumberOfVertices());
		unconnectedV.addAll(g.getVertices());
